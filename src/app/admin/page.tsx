...
const productsList = [
  { id: 1, name: "Chandan Premium Incense", category: "Incense", price: "₹349", stock: 245, status: "Active", sales: 342, rating: 4.8 },
  { id: 2, name: "Sandalwood Oil 50ml", category: "Oils", price: "₹1,890", stock: 87, status: "Active", sales: 278, rating: 4.9 },
  { id: 3, name: "Temple Puja Kit", category: "Puja Kits", price: "₹3,200", stock: 56, status: "Active", sales: 195, rating: 4.7 },
  { id: 4, name: "Jasmine Dhoop Sticks", category: "Dhoop", price: "₹249", stock: 520, status: "Active", sales: 412, rating: 4.5 },
  { id: 5, name: "Rose Attar Perfume", category: "Oils", price: "₹4,500", stock: 12, status: "Low Stock", sales: 156, rating: 4.9 },
  { id: 6, name: "Frankincense Resin", category: "Others", price: "₹1,100", stock: 0, status: "Out of Stock", sales: 89, rating: 4.3 },
  { id: 7, name: "Camphor Tablets Box", category: "Puja Kits", price: "₹320", stock: 340, status: "Active", sales: 267, rating: 4.6 },
  { id: 8, name: "Nag Champa Classic", category: "Incense", price: "₹299", stock: 198, status: "Active", sales: 389, rating: 4.7 },
];
